...
class App_window(QMainWindow):
    ...
    def create_menu(self):
        ...
        undo_Action = QAction(QIcon('Document/images/icons/undo.svg'), 'Undo', self) # 撤销操作
        undo_Action.setToolTip('Undo')
        # undo_Action.triggered.connect(self.undo)
        edit_Menu.addAction(undo_Action)
        redo_Action = QAction(QIcon('Document/images/icons/redo.svg'), 'Redo', self) # 重做操作
        redo_Action.setToolTip('Redo')
        # redo_Action.triggered.connect(self.redo)
        edit_Menu.addAction(redo_Action)
        edit_Menu.addSeparator()  # 分隔线
        cut_Action = QAction(QIcon('Document/images/icons/cut.svg'), 'Cut', self) # 剪切操作
        cut_Action.setToolTip('Cut')
        # cut_Action.triggered.connect(self.cut)
        edit_Menu.addAction(cut_Action)
        copy_Action = QAction(QIcon('Document/images/icons/copy.svg'), 'Copy', self) # 复制操作
        copy_Action.setToolTip('Copy')
        # copy_Action.triggered.connect(self.copy)
        edit_Menu.addAction(copy_Action)
        paste_Action = QAction(QIcon('Document/images/icons/paste.svg'), 'Paste', self) # 粘贴操作
        paste_Action.setToolTip('Paste')
        # paste_Action.triggered.connect(self.paste)
        edit_Menu.addAction(paste_Action)
        mode_Action = QAction(QIcon('Document/images/icons/mode.svg'), 'Mode', self) # 模式操作
